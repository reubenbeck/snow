...
path = r'D:/Users/Reuben/Internship/Snow/snow/docs/GlobSnowDataDaily'
...
for item in fileList:
    ...
    copyfile(item, os.path.join("D:\\Users\\Reuben\\Internship\\Snow\\snow\\docs\\GlobSnowMarchDailyData", filename))
